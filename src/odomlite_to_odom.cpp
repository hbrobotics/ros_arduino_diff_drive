 ...
 *
 * Original file name: dagny_odom.cpp
 */
...
void odom_cb( const ros_arduino_diff_drive::OdometryLite::ConstPtr & msg ) {
...
int main(int argc, char ** argv) {
  ros::init(argc, argv, "odomlite_to_odom");
